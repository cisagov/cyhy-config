...
issue](https://github.com/cisagov/cyhy-config/issues) in
...
request](https://github.com/cisagov/cyhy-config/pulls),
...
```console
cd cyhy-config
pyenv virtualenv <python_version_to_use> cyhy-config
pyenv local cyhy-config
